...
3. *"O design da aplicação deve seguir o styleguide e design system da Stripe, mas sem mencionar stripe no projeto."* — traduzido em tokens de design genéricos (paleta, tipografia, espaçamento) documentados no plano e implementados em `apps/web/app/globals.css`, sem qualquer referência à inspiração externa em código, nomes ou documentação.
